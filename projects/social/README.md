...
ANSWER =  500 times. Originally thought 1000. But as friendships are bi-directional, the number of calls would be halved due to one frienship affecting two users.
...
ANSWER = On average, people on social media platforms have moe than 5 friends. 
